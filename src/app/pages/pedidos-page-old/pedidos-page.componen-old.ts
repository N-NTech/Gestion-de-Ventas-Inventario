...
import { Estado } from './estado.enum-old';
...
@Component({
    ...
    templateUrl: 'pedidos-page.component-old.html',
    styleUrl: 'pedidos-page.component-old.css',
    standalone: true,
...
export class PedidosPageComponentOld implements OnInit {
